...
@section('isihalaman')
    ...
    <h4>Perpustakaan UNTIRTA</h4>
        UPT Perpustakaan Universitas Sultan Ageng Tirtayasa [UNTIRTA] sebagai salah satu perpustakaan perguruan tinggi negeri di Indonesia 
    ...
    <p>
        Perhatian pimpinan Universitas dalam pengembangan dan peningkatan layanan Perpustakaan semakin 
